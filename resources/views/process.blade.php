...
<?php
    ...
    if(isset($postData)){
        ...
        $database->getReference('admin/'.$uid.'/employees/'.$username) // this is the root reference
           ->update($updatesArr);

        header("Location: employees");
        die();
        
    }if(isset($postDataDeletion)){
        $username = $postDataDeletion['Uname'];

        $database->getReference('admin/'.$uid.'/employees/'.$username)->remove();
